          ...
          <div className="flex bg-[#442D1C]/5 p-1 rounded-full text-xs font-bold border border-[#84592B]/10">
            <button
              ...
              className={`px-3 py-1.5 rounded-full transition-all ${
                lang === "bg" ? "bg-[#442D1C] text-[#E8D1A7] shadow-sm font-bold" : "text-gray-500 hover:text-black cursor-pointer"
              }`}
            >
              BG
            </button>
            <button
              onClick={() => setLang("ru")}
              className={`px-3 py-1.5 rounded-full transition-all ${
                lang === "ru" ? "bg-[#442D1C] text-[#E8D1A7] shadow-sm font-bold" : "text-gray-500 hover:text-black cursor-pointer"
              }`}
            >
              RU
            </button>
            <button
              onClick={() => setLang("en")}
              className={`px-3 py-1.5 rounded-full transition-all ${
                lang === "en" ? "bg-[#442D1C] text-[#E8D1A7] shadow-sm font-bold" : "text-gray-500 hover:text-black cursor-pointer"
              }`}
            >
              EN
            </button>
